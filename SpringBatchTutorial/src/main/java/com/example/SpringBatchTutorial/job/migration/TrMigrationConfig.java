package com.example.SpringBatchTutorial.job.migration;
...
public class TrMigrationConfig {
    ...
    public Step trMigrationStep(ItemReader trOrdersReader, ItemProcessor trOrderProcessor, ItemWriter trOrdersWriter) {
        return stepBuilderFactory.get("trMigrationStep")
                .<Orders, Accounts>chunk(5) // 처리할 데이터의 개수(?) <읽을 데이타, 쓰기를 할 데이터>
...
//    @StepScope
//    @Bean
//    public RepositoryItemWriter trOrdersWriter() {
...
//    }
    ...
    public RepositoryItemReader<Orders> trOrdersReader() {
        return new RepositoryItemReaderBuilder<Orders>()
                ...
                .methodName("findAll")
                .pageSize(5) // 일반적으로 chunckSize와 동일하게 작성한다고 함
